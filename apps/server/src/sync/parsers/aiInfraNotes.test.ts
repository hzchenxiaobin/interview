...
describe("ai-infra-notes parser", () => {
  ...
  it("social_interview_qa：### Q 标题切分，项目题归 project", async () => {
    const { questions } = parse(await loadFixtures("ai-infra-notes"));
    ...
    expect(projectQ.category).toBe("project");
